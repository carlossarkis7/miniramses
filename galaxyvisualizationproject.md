...
![Galaxy View](images/galaxy_single_projection.png)  
*Figure: Example galaxy projection (e.g. XY plane).*
...
![Zoom into Galaxy](images/zoom_single_view.png)  
*Figure: Zoomed-in view of the central galaxy.*
